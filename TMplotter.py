...
def main():
    ...
    #initialize PySimpleGUI interactive window
    ...
    #Move interactive window to bottom right corner of screen
    global screen_width
    ...
    window1.move(x,y)
    #initialize PySimpleGUI Housekeeping window
    if 'LPC' in Instrument_name:
    ...
    #Move Housekeeping window to bottom middle of screen         
